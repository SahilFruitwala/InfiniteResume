            ...
            >
              {data.experience.map((exp) => (
                <div key={exp.id}>
                  ...
                  <div className="text-[0.95em] font-semibold text-gray-700 mb-2 uppercase tracking-wide">
                    {exp.company}
                  </div>
                  <div
            ...
            >
              {data.education.map((edu) => (
                <div key={edu.id}>
                  ...
                  <div className="text-[0.95em] text-gray-700">
                    {edu.institution}
                  </div>
                </div>
              ))}
                  ...
                  <div className="flex justify-between items-baseline mb-1">
                    ...
                    {proj.link && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-[0.9em] italic text-gray-600 hover:underline"
                      >
                        {proj.link}
                      </a>
                    )}
            ...
            >
              {data.awards.map((award) => (
                <div key={award.id}>
                  ...
                  <div className="text-[0.95em] font-semibold text-gray-700 mb-1 tracking-wide">
                    {award.issuer}
                  </div>
                  <div
                    className="leading-relaxed whitespace-pre-line [&_b]:font-bold [&_strong]:font-bold [&_i]:italic [&_em]:italic [&_u]:underline [&_ul]:list-disc [&_ul]:pl-4 [&_li]:mb-[var(--bullet-gap)] [&_ul]:my-[var(--list-margin)]"
