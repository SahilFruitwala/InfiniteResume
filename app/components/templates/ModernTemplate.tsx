...
export const ModernTemplate = memo(
  ({ data, isDark }: { data: ResumeData; isDark?: boolean }) => {
    ...
    */
    ...
    return (
      <div
        className={`flex max-w-4xl mx-auto w-full min-h-[1056px] shadow-sm print:!bg-white print:!text-gray-900 ${isDark ? "bg-[#111111] text-slate-100" : "bg-white text-gray-800"}`}
        style={
          {
