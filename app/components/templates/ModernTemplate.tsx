...
export const ModernTemplate = memo(
  ({ data, isDark }: { data: ResumeData; isDark?: boolean }) => {
    ...
    return (
      <div
        className={`flex max-w-4xl mx-auto w-full min-h-[1056px] shadow-sm ${isDark ? "bg-[#050505] text-slate-100" : "bg-white text-gray-800"}`}
        style={
          {
      ...
      >
        ...
        <div
          data-print-wrapper
          className={`w-2/3 px-8 transition-colors duration-300 ${isDark ? "bg-[#050505] text-slate-100" : "bg-slate-50 text-gray-800"}`}
          style={{
            paddingTop: `${pageMarginTop}px`,
            paddingBottom: `${pageMarginBottom}px`,
          }}
