...
export const metadata: Metadata = {
  ...
  description: 'Create a stunning, professional resume in minutes with InfiniteResume. Choose from modern, minimal, and professional templates to land your dream job.',
  applicationName: 'InfiniteResume',
  keywords: ['resume builder', 'CV maker', 'professional resume', 'career', 'job search', 'resume templates'],
