...
import { isColorTooDarkForDarkBg } from "@app/utils/colorUtils";
  ...
  ({ data, isDark }: { data: ResumeData; isDark?: boolean }) => {
    ...
    */
        ...
        case "summary":
          return data.personalInfo.summary ? (
            <section key="summary" style={{ marginBottom: `${sectionGap}px` }}>
              <h2
                className={`font-black uppercase tracking-widest ${isDark ? "text-slate-100" : "text-gray-900"} border-l-4 pl-3`}
                style={{
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: sanitizeRichText(data.personalInfo.summary),
                }}
              />
            </section>
          ) : null;
                ...
                {data.experience.map((exp) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline mb-1">
                      <h3
                        className={`font-extrabold ${isDark ? "text-slate-100" : "text-gray-900"}`}
                        style={{
                    ...
                    <div
                      className={`text-[1.05em] font-medium ${isDark ? "text-slate-200" : "text-gray-800"} mb-2`}
                    >
                      {exp.company}
                    </div>
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: sanitizeRichText(exp.description),
                      }}
                    />
                  </div>
                ))}
              ...
              >
                {data.education.map((edu) => (
                  ...
                  >
                    ...
                    <div
                      className={`text-[1.05em] font-medium ${isDark ? "text-slate-200" : "text-gray-800"}`}
                    >
                      {edu.institution}
                    </div>
                  </div>
                ...
                {data.projects.map((proj) => (
                  ...
                  >
                    ...
                    <div
                      className={`leading-relaxed whitespace-pre-line [&_b]:font-bold [&_strong]:font-bold [&_i]:italic [&_em]:italic [&_u]:underline [&_ul]:list-disc [&_ul]:pl-4 [&_li]:mb-[var(--bullet-gap)] [&_ul]:my-[var(--list-margin)] ${isDark ? "text-slate-300" : "text-gray-600"}`}
                      dangerouslySetInnerHTML={{
                        __html: sanitizeRichText(proj.description),
                      }}
                    />
                  </div>
                ))}
              ...
              >
                {data.volunteerWork.map((vol) => (
                  ...
                  >
                    ...
                    <div
                      className={`text-[1.05em] font-medium mb-2 ${isDark ? "text-slate-200" : "text-gray-800"}`}
                    >
                      {vol.organization}
                    </div>
                    <div
                      className={`leading-relaxed whitespace-pre-line [&_b]:font-bold [&_strong]:font-bold [&_i]:italic [&_em]:italic [&_u]:underline [&_ul]:list-disc [&_ul]:pl-4 [&_li]:mb-[var(--bullet-gap)] [&_ul]:my-[var(--list-margin)] ${isDark ? "text-slate-300" : "text-gray-600"}`}
                      dangerouslySetInnerHTML={{
                        __html: sanitizeRichText(vol.description),
                      }}
                    />
                  </div>
                ))}
              ...
              >
                {data.awards.map((award) => (
                  ...
                  >
                    ...
                    <div
                      className={`text-[1.05em] font-medium mb-1 ${isDark ? "text-slate-200" : "text-gray-800"}`}
                    >
                      {award.issuer}
                    </div>
                    <div
                      className={`leading-relaxed whitespace-pre-line [&_b]:font-bold [&_strong]:font-bold [&_i]:italic [&_em]:italic [&_u]:underline [&_ul]:list-disc [&_ul]:pl-4 [&_li]:mb-[var(--bullet-gap)] [&_ul]:my-[var(--list-margin)] ${isDark ? "text-slate-300" : "text-gray-600"}`}
                      dangerouslySetInnerHTML={{
                        __html: sanitizeRichText(award.description),
                      }}
                    />
                  </div>
                ))}
        ...
        case "languages":
          return data.languages && data.languages.length > 0 ? (
            ...
            >
              ...
              <div
                className={`flex flex-wrap gap-4 leading-relaxed ${isDark ? "text-slate-300" : "text-gray-800"}`}
              >
            ...
            <section key="skills" style={{ marginBottom: `${sectionGap}px` }}>
              ...
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 flex flex-col gap-4">
                {data.skills.map((category) => (
                  <div key={category.id}>
                    <h3
                      className={`font-extrabold ${isDark ? "text-slate-100" : "text-gray-900"} mb-1`}
                      style={{
                        fontSize: `${typography?.fontSizeItemHeading ?? 18}px`,
                      }}
                    >
                    ...
                    <div
                      className={`leading-relaxed whitespace-pre-line [&_b]:font-bold [&_strong]:font-bold [&_i]:italic [&_em]:italic [&_u]:underline [&_ul]:list-disc [&_ul]:pl-4 [&_li]:mb-[var(--bullet-gap)] [&_ul]:my-[var(--list-margin)] ${isDark ? "text-slate-300" : "text-gray-700"}`}
                      dangerouslySetInnerHTML={{
                        __html: sanitizeRichText(category.skills),
                      }}
                    />
                  </div>
                ))}
    ...
    return (
      <div
        data-print-wrapper
        className={`transition-colors duration-300 max-w-4xl mx-auto w-full min-h-[1056px] print:!min-h-0 relative print:!shadow-none print:!bg-white print:!text-gray-900 ${isDark ? "bg-[#111111] text-slate-100" : "bg-white text-gray-900"}`}
        style={
          {
      ...
      >
        ...
        >
          <header
            className={`mb-12 flex flex-col md:flex-row gap-8 items-center md:items-start pb-8 border-b-2 ${isDark ? "border-white/10" : "border-gray-100"}`}
            style={{ marginBottom: `${sectionGap}px` }}
          >
            ...
            <div className="flex-1 text-center md:text-left">
              <h1
                className={`font-black tracking-tight mb-3 ${isDark ? "text-slate-100" : "text-gray-900"} leading-none`}
