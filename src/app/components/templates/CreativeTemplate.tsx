...
export const CreativeTemplate = memo(
  ({ data, isDark }: { data: ResumeData; isDark?: boolean }) => {
    ...
    */
    ...
    return (
      <div
        className={`transition-colors duration-300 max-w-4xl mx-auto w-full min-h-[1056px] overflow-hidden relative shadow-md print:!bg-white print:!text-gray-900 ${isDark ? "bg-[#111111] text-slate-100" : "bg-white text-gray-900"}`}
        style={
          {
